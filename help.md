...
```
macroclaw.app (46.225.235.55)         本地 Mac
┌─────────────────────┐      ┌──────────────────────────────┐
...
podcasts:
  - name: "非共识的20分钟"
    rss_url: "http://46.225.235.55:1200/xiaoyuzhou/podcast/6978a31df828d4e9f2787d3d"
    tags: ["finance", "macro"]

  # 新增播客 ↓
  - name: "播客名称"
    rss_url: "http://46.225.235.55:1200/xiaoyuzhou/podcast/你的播客ID"
    tags: ["标签1", "标签2"]
```
...
```bash
curl "http://46.225.235.55:1200/xiaoyuzhou/podcast/你的播客ID" | head -20
```
...
```bash
curl "http://46.225.235.55:1200/xiaoyuzhou/podcast/播客ID" -s | grep -o 'url="[^"]*\.m4a' | head -5
```
